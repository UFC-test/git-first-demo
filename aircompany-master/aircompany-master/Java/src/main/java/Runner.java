...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Airport passengerAirport = new Airport(airport.getpassengerPlaneRepublicOfBelarus());
        ...
        System.out.println("Passenger airport sorted by max speed: " + passengerAirport
                .sortByMaxSpeed()
                .toString());
        System.out.println("Plane with maximumNumberOfPassengers: " + passengerAirport.getPassengerPlaneWithMaximumNumberOfPassengers());
    }
}
